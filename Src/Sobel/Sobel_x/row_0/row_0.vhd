...
architecture Behavioral of row_0 is

    type state_type is (init, state_1, state_2, state_3, compute, output);
    signal state     : state_type := init;

    signal data_1    : unsigned(12 downto 0);
    signal data_2    : unsigned(12 downto 0);
    signal data_3    : unsigned(12 downto 0);
        ...
        if rising_edge(clk) then
            if reset = '1' then
                ...
                case state is
                    ...
                    when state_3 =>
                        if flag = '1' then
                            result <= result + resize(data_2 * 2, 13);
                            flag <= '0';
                        elsif valid_in = '1' then
